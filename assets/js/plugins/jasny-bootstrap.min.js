...
!function(u) {
    ...
    var i = "Microsoft Internet Explorer" == window.navigator.appName
      , n = function(e, t) {
        ...
        0 !== this.$input.length) {
            ...
            0 === this.$hidden.length && (this.$hidden = u('<input type="hidden">').insertBefore(this.$input)),
    ...
    n.prototype.listen = function() {
        ...
        u(this.$input[0].form).on("reset.bs.fileinput", u.proxy(this.reset, this)),
        this.$element.find('[data-trigger="fileinput"]').on("click.bs.fileinput", u.proxy(this.trigger, this)),
        this.$element.find('[data-dismiss="fileinput"]').on("click.bs.fileinput", u.proxy(this.clear, this))
    }
    ,
    n.prototype.verifySizes = function(e) {
        if (void 0 === this.options.maxSize)
            return !0;
    ...
    n.prototype.resetOrientation = function(s, r) {
        ...
        a.onload = function() {
            var e = a.width
              ...
              , n = i.getContext("2d");
            switch (-1 < [5, 6, 7, 8].indexOf(r) ? (i.width = t,
            i.height = e) : (i.width = e,
            i.height = t),
            r) {
            case 2:
    ...
    n.prototype.clear = function(e) {
        ...
        void 0 !== e && (this.$input.trigger("change"),
